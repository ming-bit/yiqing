        ...
        <div class="box-left">
            ...
            <div class="left-bottom" class="select">
                <div class="title-box">
                    <h6>各省的疫情分析</h6>
                    <!--onchange类似于触发器 -->
                    <select id="proNameOne" style="height:20px;width:50px;margin-left:10px;font-size: 12px" onchange="selectByName()">
...
<script type="text/javascript" src="myjs/infoController.js"></script><!--     src="js/my.js">   -->
<script type="text/javascript" src="myjs/yiqingfenxi.js"></script>
<script type="text/javascript" src="myjs/selectAllCountByPName.js"></script>
